...
ti = 500                      # Initial timestep read
tf = 800                      # Final timestep read

num_nodes = 164343         # 0 a 164342
num_time_steps = tf - ti

#training_params = np.array([100, 200, 300, 350, 400, 450, 500, 600, 700])
training_params = np.array([100, 200, 300, 302, 305, 400, 500, 600, 700])
...
pdmd_monolithic.dmd_time["t0"] = 0
pdmd_monolithic.dmd_time["tend"] = tf - ti - 1
...
original_300 = training_snapshots[2, :, :]
...
with open(f'E:/Parametric_DMD_output-{time_title[0:19]}.txt', 'a') as txt_log:
    ...
    txt_log.write('\n')
    txt_pdmd_monolithic1 = str(pdmd_monolithic.dmd_time["t0"])
    txt_pdmd_monolithic2 = str(pdmd_monolithic.dmd_time["tend"])
    txt_log.write('pdmd_monolithic.dmd_time[t0]: ' + txt_pdmd_monolithic1 + '\n')
    txt_log.write('pdmd_monolithic.dmd_time[tend]: ' + txt_pdmd_monolithic2 + '\n')
    txt_log.write('\n')
    txt_log.write('\n')
    txt_log.write('\n')
